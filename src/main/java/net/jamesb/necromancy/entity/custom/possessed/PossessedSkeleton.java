...
public class PossessedSkeleton extends PossessedEntity {
    public PossessedSkeleton(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public boolean hurt(DamageSource pSource, float pAmount) {
        ...
        if (this.getHealth() <= 0)
        {
            ...
            Skeleton selfMobType = new Skeleton(EntityType.SKELETON, this.level());
