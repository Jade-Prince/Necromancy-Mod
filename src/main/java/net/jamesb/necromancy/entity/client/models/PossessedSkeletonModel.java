package net.jamesb.necromancy.entity.client.models;// Made with Blockbench 4.9.2
...
public class PossessedSkeletonModel<T extends Entity> extends EntityModel<T> {
	...
	public PossessedSkeletonModel(ModelPart root) {
